package edu.westga.cs1302.task_tracker.model.containterTask;
...
class TestConstructor {
    ...
    @Test
    void testInitializesEmptySubtaskList() {
        ContainerTask container = new ContainerTask("name", "desc", TaskPriority.MEDIUM);
        assertNotNull(container.getSubTasks());
