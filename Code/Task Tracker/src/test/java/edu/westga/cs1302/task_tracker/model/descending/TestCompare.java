...
class TestCompare {
    ...
    void testCompareLowAndLow() {
        ...
        assertEquals(0, descending.compare(t1, t2), "LOW vs LOW should return 0");
    }
    ...
    void testCompareMediumAndMedium() {
		...
		assertEquals(0, descending.compare(t1, t2), "MEDIUM vs MEDIUM should return 0");
    }
    ...
    void testCompareHighAndHigh() {
        ...
        assertEquals(0, descending.compare(t1, t2), "HIGH vs HIGH should return 0");
    }
    ...
    void testCompareLowAndMedium() {
        Task t1 = new Task("Shopping", "Buy halloween costume", TaskPriority.LOW);
        Task t2 = new Task("Read", "Read first half of assigned book", TaskPriority.MEDIUM);
        assertTrue(descending.compare(t1, t2) > 0, "LOW should come before MEDIUM");
    }
    ...
    void testCompareLowAndHigh() {
        ...
        assertTrue(descending.compare(t1, t2) > 0, "LOW should come before HIGH");
    }
    ...
    void testCompareMediumAndLow() {
        ...
        assertTrue(descending.compare(t1, t2) < 0, "MEDIUM should come after LOW");
    }
    ...
    void testCompareMediumAndHigh() {
        ...
        Task t2 = new Task("Meet with advisor", "Plan Spring classes", TaskPriority.HIGH);
        assertTrue(descending.compare(t1, t2) > 0, "MEDIUM should come before HIGH");
    }
    ...
    void testCompareHighAndLow() {
        Task t1 = new Task("Finish Lab 6", "Commit Part A. Start Part B and C", TaskPriority.HIGH);
        Task t2 = new Task("Shopping", "Buy halloween costume", TaskPriority.LOW);
        assertTrue(descending.compare(t1, t2) < 0, "HIGH should come after LOW");
    }
    ...
    void testCompareHighAndMedium() {
        Task t1 = new Task("Finish Lab 6", "Commit Part A. Start Part B and C", TaskPriority.HIGH);
        Task t2 = new Task("Read", "Read first half of assigned book", TaskPriority.MEDIUM);
        assertTrue(descending.compare(t1, t2) < 0, "HIGH should come after MEDIUM");
    }
